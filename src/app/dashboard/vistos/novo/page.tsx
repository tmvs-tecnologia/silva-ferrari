            ...
            <div className="space-y-8">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                ...
                <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
                    {formData.type === "Turismo" && (
                        <>
                            <DocumentRow label="Reservas de Passagens" field="reservasPassagens" docField="reservasPassagensDoc" />
                            <DocumentRow label="Reservas de Hotel" field="reservasHotel" docField="reservasHotelDoc" />
                            <DocumentRow label="Seguro Viagem" field="seguroViagem" docField="seguroViagemDoc" />
                            <DocumentRow label="Roteiro de Viagem Detalhado" field="roteiroViagem" docField="roteiroViagemDoc" />
                            <DocumentRow label="Taxa Consular" field="taxa" docField="taxaDoc" />
                            <DocumentRow label="Formulário do Consulado preenchido" field="formularioConsulado" docField="formularioConsuladoDoc" />
                        </>
                    )}
                     {formData.type !== "Turismo" && (
